...
import { LogIn, Mail, Lock, AlertCircle, Laptop } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Gagal masuk. Silakan periksa email/password.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl">
        <div className="flex flex-col items-center gap-6 mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-400 text-sm">Masuk untuk melihat detail layanan premium kami.</p>
          </div>
        </div>
